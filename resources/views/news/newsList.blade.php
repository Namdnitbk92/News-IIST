               ...
               <tr>
                ...
                @if(Auth::user()->isCreater())
                    @if($titlePage === trans('app.news_list'))
                      ...
                      @endif
                      <a {!! addTooltip(trans('app.copy_new')) !!} class="panel-edit" href="javascript:void(0);" onclick="quickNews('{{$new->id}}');"><i class="fa fa-files-o" aria-hidden="true"></i></a>&nbsp;
